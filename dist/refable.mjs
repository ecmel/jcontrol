  ...
  constructor() {
    r.add(this),
      ...
      e(
        this,
        n,
        new MutationObserver((e) => t(this, r, "m", i).call(this, e)),
        "f"
      );
  }
  register(e, r) {
  ...
  run() {
    new Promise((t) => {
      ...
      document
        ...
        t(this, n, "f").observe(document, { childList: !0, subtree: !0 });
    });
  }
}
(o = new WeakMap()),
  ...
  (l = function (e) {
    ...
    if (!r) {
      const n = e.getAttribute("data-controller"),
        i = t(this, o, "f").get(n);
      (r = new i(e, this)),
        t(this, a, "f").set(e, r),
...
export { u as Application, w as Controller };
//# sourceMappingURL=refable.mjs.map
